     ...
     <div id="project" className='flex flex-col items-center pb-30 pt-5 px-2 '>
       <h1 className='text-white text-3xl lg:text-6xl font-bold pb-20'>My Projects</h1>
        <div className='flex flex-wrap gap-x-15 gap-y-25 justify-center  lg:px-30'>
           {/*    project one   */}
            <div className='flex flex-col justify-between  w-80 h-130 p-2 bg-white  border-white border-1 rounded-xl'>
              <div>
              ...
              {/*    project two   */}
            <div className='flex flex-col justify-between w-80 h-130 p-5 bg-white  border-white border-1 rounded-xl'>
              <div>
                 ...
                 <h1 className='text-center text-xl pt-5 pb-2 font-bold text-indigo-400'>Library-Management-System</h1>
                  <p className=' tracking-wider h-50 overflow-y-auto scrollbar-none p-1'><span className='text-lg font-bold'>Description :- </span>A web application that allows users to request books, which are then processed by the admin. Users can view available books and make requests, while the admin manages book issuance and keeps track of the library collection. Built with HTML, CSS, JavaScript, Node.js, Express.js, and MongoDB, it provides a simple and organized interface for library management.</p>
              </div>
