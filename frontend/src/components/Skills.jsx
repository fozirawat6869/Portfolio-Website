   ...
   <>
     <div id="skills" className='pt-20 flex flex-col items-center pb-50  flex-wrap'>
       <p className='text-gray-300 text-xl text-center'>Explore my</p>
        <h1 className='pt-2 text-white text-6xl font-bold text-center pb-18'>Skills</h1>
         <div className='flex gap-10 '>
           <div className='flex flex-col gap-3 text-white border-1 border-white px-10 py-15 rounded-[30px] w-60 hover:scale-110 transition-all duration-300'> 
            ...
            <div className='flex flex-col gap-3 text-white border-1 w-60 border-white p-10 rounded-[30px] hover:scale-110 transition-all duration-300 '> 
             ...
             <div className='flex flex-col gap-3 text-white border-1 w-60 border-white p-10 rounded-[30px]  hover:scale-110 transition-all duration-300 cursor-pointer'> 
             ...
             <div className='flex flex-col gap-3 text-white border-1 border-white p-10 rounded-[30px] w-60  hover:scale-110 transition-all duration-300 cursor-pointer'> 
