...
function Nav() {
  return (
    <>
     <nav className='flex justify-between  px-40 items-center  flex-wrap sticky top-0 w-full bg-black z-1 border-b-1 border-blue-500'>
        <h1 className=' py-5 font-bold text-3xl text-blue-500'>My Portfolio </h1>
        <ul className='flex gap-12 flex-wrap justify-center  py-3 text-xl '>
